...
const urlsToCache = [
  '/app-de-servico/',
  '/app-de-servico/painel_plataforma.html',
  '/app-de-servico/painel_servicos.html',
  '/app-de-servico/os_cliente.html',
  '/app-de-servico/firebase-config.js',
  '/app-de-servico/manifest.json',
...
self.addEventListener('notificationclick', event => {
  ...
  if (event.action === 'abrir') {
    event.waitUntil(
      clients.openWindow('/app-de-servico/painel_servicos.html')
    );
  }
});